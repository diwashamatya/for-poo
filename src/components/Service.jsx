  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-end">
        <h1 className="text-[22px] text-[#0C1A97] pl-5 mb-[-5px]">All Services</h1>
        <button
      ...
      <div className="max-h-[250px] overflow-y-auto">
        <table className="table-auto border rounded-md">
          <thead className="border rounded-[100px] sticky top-0 z-10">
            <tr className="h-[50px]  text-[15px] bg-[#d6e0fa] ">
              ...
              <th className="font-man font-medium md:w-[130px]">Visibility</th>
              ...
              <tr key={item.id} className="border h-[40px] bg-[#f4f2f2]">
                ...
                <td className="  text-center ">
                  <div className="flex gap-2 items-center justify-center w-[200px]  ">
                    ...
                    <img src={trash} className="w-5" alt="yellow"></img>
                  </div>
                </td>
              </tr>
            ))}
