...
const Dashboard = () => {
  return (
    <div className="bg-[#F1F6F9] w-full p-12">
      ...
      <Cards />
      <div className="p-5 mt-6 w-full border w-full rounded-[20px] bg-[#E8E8E8] h-[375px]">
        <div className=" p-4">
            ...
            <div className="p-1 flex">
                <div className="bg-white h-[75px] w-full rounded-[5px] flex items-center justify-between px-8">
                    <div>
                    <h2 className="text-[#346AFF] text-[18px]">Yesterday</h2>
                    </div>
            ...
            <div className="p-1 flex">
                <div className="bg-white h-[75px] w-full rounded-[5px] flex items-center justify-between px-8">
                    <div>
                    <h2 className="text-[#346AFF] text-[18px]">Today</h2>
                    </div>
            ...
            <div className="p-1 flex">
                <div className="bg-white h-[75px] w-full rounded-[5px] flex items-center justify-between px-8">
                    <div>
                    <h2 className="text-[#346AFF] text-[18px]">Tomorrow</h2>
                    </div>
